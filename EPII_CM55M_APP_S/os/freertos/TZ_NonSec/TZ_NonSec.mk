...
##
OS_FREERTOS_DIR = $(OSES_ROOT_DIR)/TZ_NonSec/freertos_kernel
OS_FREERTOS_CFG_DIR = $(OSES_ROOT_DIR)/TZ_NonSec/config
OS_FREERTOS_SECCONTEXT_DIR = $(OSES_ROOT_DIR)/TZ_NonSec/secure_context
ifeq ($(MPU), y)
...
##
OS_FREERTOS_PORT_CSRCDIR	= $(OS_FREERTOS_DIR)/portable/GCC/ARM_CM55/non_secure \
				$(OS_FREERTOS_DIR)/portable $(OS_FREERTOS_DIR)/portable/MemMang \
				$(OS_FREERTOS_MPU_WRAPPER_DIR)
				
OS_FREERTOS_PORT_ASMSRCDIR	= $(OS_FREERTOS_DIR)/portable/GCC/ARM_CM55/non_secure \
				$(OS_FREERTOS_DIR)/portable $(OS_FREERTOS_DIR)/portable/MemMang \
				$(OS_FREERTOS_MPU_WRAPPER_DIR)				
...
##
OS_FREERTOS_CSRCDIR	= $(OS_FREERTOS_PORT_CSRCDIR) $(OS_FREERTOS_DIR) $(OS_FREERTOS_SECCONTEXT_DIR)
OS_FREERTOS_ASMSRCDIR	= $(OS_FREERTOS_PORT_ASMSRCDIR) $(OS_FREERTOS_DIR) $(OS_FREERTOS_SECCONTEXT_DIR)
OS_FREERTOS_INCDIR	= $(OS_FREERTOS_PORT_INCDIR) $(OS_FREERTOS_DIR)/include $(OS_FREERTOS_CFG_DIR) $(OS_FREERTOS_SECCONTEXT_DIR)
...
OS_FREERTOS_DEFINES += -DFREERTOS_NS
