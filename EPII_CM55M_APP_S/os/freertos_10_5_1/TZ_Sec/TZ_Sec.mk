...
##
OS_FREERTOS_DIR = $(OSES_ROOT_DIR)/TZ_Sec/freertos_kernel
OS_FREERTOS_CFG_DIR = $(OSES_ROOT_DIR)/TZ_Sec/config
##
# \brief 		freertos port sources and includes definition
##
OS_FREERTOS_PORT_CSRCDIR	= $(OS_FREERTOS_DIR)/portable/GCC/ARM_CM55/secure 
OS_FREERTOS_PORT_ASMSRCDIR	= $(OS_FREERTOS_DIR)/portable/GCC/ARM_CM55/secure
OS_FREERTOS_PORT_INCDIR		= $(OS_FREERTOS_DIR)/portable/GCC/ARM_CM55/secure
##
...
OS_FREERTOS_DEFINES += -DFREERTOS_S
