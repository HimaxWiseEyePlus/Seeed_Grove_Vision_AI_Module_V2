...
static void dp_app_cv_eventhdl_cb(EVT_INDEX_E event)
{
	...
	case EVT_INDEX_HXAUTOI2C_ERR:
		...
		g_hxautoi2c_error = 1;
		break;
	case EVT_INDEX_PILBOI_BTN_DOWN:
		dbg_printf(DBG_LESS_INFO,"EVT_INDEX_PILBOI_BTN_DOWN\r\n");
		sensordplib_retrigger_capture();
		break;
	case EVT_INDEX_PILBOI_BTN_UP:
		dbg_printf(DBG_LESS_INFO,"EVT_INDEX_PILBOI_BTN_UP\r\n");
		break;
	default:
		...
		uint8_t v = 0;
		v = get_value();
		dbg_printf(DBG_LESS_INFO, "===================================  val %d \n", v);
