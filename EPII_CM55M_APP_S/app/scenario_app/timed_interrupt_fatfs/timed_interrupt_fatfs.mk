...
APPL_DEFINES += -DTIMED_INTERRUPT_FATFS
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/timed_interrupt_fatfs.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/timed_interrupt_fatfs.ld
endif
