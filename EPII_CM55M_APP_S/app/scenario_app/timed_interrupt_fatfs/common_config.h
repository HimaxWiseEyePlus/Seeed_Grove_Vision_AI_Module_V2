...
#ifndef SCENARIO_APP_COMMON_CONFIG_TIMED_INTERRUPT_H_
#define SCENARIO_APP_COMMON_CONFIG_TIMED_INTERRUPT_H_
...
#endif /* SCENARIO_APP_COMMON_CONFIG_TIMED_INTERRUPT_H_ */
