...
#define IMGCAP_TASK_QUEUE_LEN 10
...
int app_main(void)
{
	...
	xImgCapTaskQueue = xQueueCreate(IMGCAP_TASK_QUEUE_LEN, sizeof(APP_MSG_T));
	if (xImgCapTaskQueue == 0)
	{
		dbg_printf(DBG_LESS_INFO, "xImgCapTaskQueue creation failed!.\r\n");
		while (1)
			;
	}
