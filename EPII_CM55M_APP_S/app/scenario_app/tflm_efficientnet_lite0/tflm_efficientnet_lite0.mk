...
APPL_DEFINES += -DTFLM_EFFICIENTNET_LITE0
...
##
LIB_SEL = pwrmgmt sensordp tflmtag2209_u55tag2205 spi_ptl spi_eeprom hxevent img_proc ccontrol
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/tflm_efficientnet_lite0.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/tflm_efficientnet_lite0.ld
endif
