...
APPL_DEFINES += -DSCENARIO_DC_SCL_SCH_TZ_S_ONLY
...
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/dc_scl_sch_tz_s_only.sct
else#TOOLChain
override LINKER_SCRIPT_FILE := $(SCENARIO_APP_ROOT)/$(APP_TYPE)/dc_scl_sch_tz_s_only.ld
endif
