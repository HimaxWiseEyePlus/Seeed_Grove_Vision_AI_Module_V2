...
#ifndef APP_SCENARIO_DC_SCL_SCH_TZ_S_ONLY__CISDP_SENSOR_H_
#define APP_SCENARIO_DC_SCL_SCH_TZ_S_ONLY__CISDP_SENSOR_H_
...
#endif /* APP_SCENARIO_DC_SCL_SCH_TZ_S_ONLY__CISDP_SENSOR_H_ */
