...
#ifndef APP_SCENARIO_ALLON_JPEG_DECODE_COMMON_CONFIG_H_
#define APP_SCENARIO_ALLON_JPEG_DECODE_COMMON_CONFIG_H_
...
#endif /* APP_SCENARIO_ALLON_JPEG_DECODE_COMMON_CONFIG_H_ */
