...
// if defined the chnage to DP_MCLK_SRC_INT_SEL_RC36M
//#define MCLKUSESRC36M

// Use different HM0360 register settings. See summary.md
...
HX_CIS_ERROR_E cisdp_sensor_set_mode(mode_select_t mode, uint8_t numFrames, uint16_t sleepTime);
