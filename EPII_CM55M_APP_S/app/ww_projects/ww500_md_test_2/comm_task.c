...
#include "board.h"
#include "i2c_comm.h"
#include "../ww500_md_test_2/evt_i2ccomm.h"
#include "../ww500_md_test_2/app_msg.h"
#include "../ww500_md_test_2/app_state.h"
...
uint8_t evt_i2ccomm_0_rx_cb(void)
{
    ...
    switch (feature)
    {
        ...
        case I2CCOMM_FEATURE_CUSTOMER_MIN ... I2CCOMM_FEATURE_CUSTOMER_MAX:
			// CGP I seem to have received one of these events - presumably fromthe MKL62BA.
			// Need to handle this:
			...
			if (i2ccomm_cmd_customer_process != NULL) {
				...
				dbg_evt_iics_cmd("Ignoring unexpected I2C event!!!!\n");
			}
        break;
