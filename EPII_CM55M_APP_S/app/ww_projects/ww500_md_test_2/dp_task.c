...
// This duplicates defines in cisdp_cfg.h and allon_sensor_tflm.c
...
#include "xprintf.h"
#include "board.h"
#include "../ww500_md_test_2/app_msg.h"
#include "../ww500_md_test_2/app_state.h"
#include "xprintf.h"
#include "board.h"
#include "../ww500_md_test_2/app_msg.h"
#include "../ww500_md_test_2/app_state.h"
#include "../ww500_md_test_2/dp_task.h"
#include "../ww500_md_test_2/comm_task.h"
#include "../ww500_md_test_2/algo_task.h"
#include "ww500_md_test_2.h"
#include "powermode_export.h"
#include "../ww500_md_test_2/common_config.h"
#include "../ww500_md_test_2/person_detect_model_data_vela.h"
#include "../ww500_md_test_2/cvapp.h"
#include "../ww500_md_test_2/cis_sensor/cis_hm0360/cisdp_sensor.h"
#include "../ww500_md_test_2/cis_sensor/cis_hm0360/cisdp_cfg.h"
...
TickType_t captureStartTime;
TickType_t captureStopTime;
...
void os_app_dplib_cb(SENSORDPLIB_STATUS_E event)
{
    ...
    case SENSORDPLIB_STATUS_XDMA_FRAME_READY:
    	captureStopTime = xTaskGetTickCount();  // Get stop time
		// Convert ticks to milliseconds
		uint32_t elapsedMs = (captureStopTime - captureStartTime) * portTICK_PERIOD_MS;
		printf("Frame capture took %lums\n", elapsedMs);
    ...
    for (;;)
    {
    	if (xQueueReceive ( xDPTaskQueue , &(dp_recv_msg) , __QueueRecvTicksToWait ) == pdTRUE )
        {
            ...
            case APP_MSG_DPEVENT_STOPCAPTURE:
            	// Not actually used in the example
            ...
            case APP_MSG_DPEVENT_RECAPTURE:
                ...
                captureStartTime = xTaskGetTickCount();  // Get start time
