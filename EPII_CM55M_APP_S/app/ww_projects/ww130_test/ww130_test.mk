...
$(info In ww130_test.mk LINKER_SCRIPT_FILE='${LINKER_SCRIPT_FILE}')
##
...
$(info In ww130_test.mk CIS_SUPPORT_INAPP_MODEL='${CIS_SUPPORT_INAPP_MODEL}' SCENARIO_APP_INCDIR='${SCENARIO_APP_INCDIR}')
